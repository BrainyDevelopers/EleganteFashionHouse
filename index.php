										...
										<div class="tab-content">
										  <div class="tab-pane active" id="men">
											<ul class="nav-list list-inline">
												<li><a href="View\Customer\women.php"><img src="images/t7.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\women.php"><img src="images/t8.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\women.php"><img src="images/t9.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\women.php"><img src="images/t11.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\women.php"><img src="images/t1.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\women.php"><img src="images/t12.jpg" class="img-responsive" alt=""/></a></li>
											</ul>
										  </div>
									   </div>
									</div>
								...
								<div class="dropdown-menu mega-dropdown-menu">
									<div class="container-fluid">
										...
										<div class="tab-content">
										  <div class="tab-pane active" id="men">
											<ul class="nav-list list-inline">
												<li><a href="View\Customer\men.php"><img src="images/t10.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\men.php"><img src="images/t2.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\men.php"><img src="images/t3.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\men.php"><img src="images/t4.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\men.php"><img src="images/t5.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="View\Customer\men.php"><img src="images/t6.jpg" class="img-responsive" alt=""/></a></li>
											</ul>
										  </div>
	...
	<div class="container">
		...
		<div class="container">
				<div class="col-md-3 footer-bottom-cate animated wow fadeInLeft" data-wow-delay=".5s">
					<h6>Categories</h6>
					<ul>
						<li><a href="View\Customer\products.php">Curabitur sapien</a></li>
						<li><a href="View\Customer\single.php">Dignissim purus</a></li>
						<li><a href="View\Customer\men.php">Tempus pretium</a></li>
						<li><a href="View\Customer\products.php">Dignissim neque</a></li>
						<li><a href="View\Customer\single.php">Ornared id aliquet</a></li>
				...
				<div class="col-md-3 footer-bottom-cate animated wow fadeInLeft" data-wow-delay=".5s">
					...
					<ul>
						<li><a href="View\Customer\products.php">Dignissim purus</a></li>
						<li><a href="View\Customer\men.php">Curabitur sapien</a></li>
						<li><a href="View\Customer\single.php">Tempus pretium</a></li>
						<li><a href="View\Customer\men.php">Dignissim neque</a></li>
						<li><a href="View\Customer\products.php">Ornared id aliquet</a></li>
					</ul>
				</div>
				<div class="col-md-3 footer-bottom-cate animated wow fadeInRight" data-wow-delay=".5s">
					<h6>Top Brands</h6>
					<ul>
						<li><a href="View\Customer\products.php">Tempus pretium</a></li>
						<li><a href="View\Customer\single.php">Curabitur sapien</a></li>
						<li><a href="View\Customer\men.php">Dignissim purus</a></li>
						<li><a href="View\Customer\single.html">Dignissim neque</a></li>
						<li><a href="View\Customer\men.php">Ornared id aliquet</a></li>
				...
				<div class="content-top">
					<div class="content-top1">
						<div class="col-md-3 col-md2 animated wow fadeInLeft" data-wow-delay=".5s">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="View/Customer/single.php">
									<img class="img-responsive" src="View/images/pi5.png" alt="" />
								</a>
								<h3><a href="View/Customer/single.php">Palazzo</a></h3>
								<div class="price">
										<h5 class="item_price">$450</h5>
					...
					<div class="content-top1">
						<div class="col-md-3 col-md2 animated wow fadeInLeft" data-wow-delay=".5s">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="View/Customer/single.php">
									<img class="img-responsive" src="View/images/pi3.png" alt="" />
								</a>
								<h3><a href="View/Customer/single.php">Palazoo</a></h3>
								<div class="price">
										<h5 class="item_price">$300</h5>
					...
					<div class="col-md-3 col-md2 animated wow fadeInRight" data-wow-delay=".5s">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="View/Customer/single.php">
									<img class="img-responsive" src="View/images/pi6.png" alt="" />
								</a>
								<h3><a href="View/Customer/single.php">Trouser</a></h3>
								<div class="price">
										<h5 class="item_price">$300</h5>
					...
					<div class="col-md-3 col-md2 cmn animated wow fadeInRight" data-wow-delay=".5s">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="View/Customer/single.php">
									<img class="img-responsive" src="View/images/pi8.png" alt="" />
								</a>
								<h3><a href="View/Customer/single.php">Palazoo</a></h3>
								<div class="price">
										<h5 class="item_price">$300</h5>
			...
			<div class="con-tp">
				<div class="container">
					<div class="col-md-4 con-tp-lft animated wow fadeInLeft" data-wow-delay=".5s">
						<a href="View/Customer/products.php">
							<div class="content-grid-effect slow-zoom vertical">
								<div class="img-box"><img src="View/images/6.jpg" alt="image" class="img-responsive zoom-img"></div>
								<div class="info-box">
									<div class="info-content simpleCart_shelfItem">
												<h4>30%offer</h4>
									</div>
					...
					<div class="col-md-4 con-tp-lft animated wow fadeInDown animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
						<a href="View/Customer/products.php">			
							<div class="content-grid-effect slow-zoom vertical">
								<div class="img-box"><img src="View/images/10.jpg" alt="image" class="img-responsive zoom-img"></div>
									<div class="info-box">
										<div class="info-content simpleCart_shelfItem">
												<h4>45%offer</h4>	
										</div>
					...
					<div class="col-md-4 con-tp-lft animated wow fadeInRight" data-wow-delay=".5s">
						<a href="View/Customer/products.php">
							<div class="content-grid-effect slow-zoom vertical">
								<div class="img-box"><img src="View/images/9.jpg" alt="image" class="img-responsive zoom-img"></div>
									<div class="info-box">
										<div class="info-content simpleCart_shelfItem">
												<h4>50%offer</h4>	
										</div>
				...
				<div class="col-md-4 con-tp-lft animated wow fadeInLeft" data-wow-delay=".5s">
					<a href="View/Customer/products.php">
						<div class="content-grid-effect slow-zoom vertical">
							<div class="img-box"><img src="View/images/12.jpg" alt="image" class="img-responsive zoom-img"></div>
								<div class="info-box">
									<div class="info-content simpleCart_shelfItem">
											<h4>25%offer</h4>	
									</div>
				...
				<div class="col-md-4 con-tp-lft animated wow fadeInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
					<a href="View/Customer/products.php">
						<div class="content-grid-effect slow-zoom vertical">
							<div class="img-box"><img src="View/images/13.jpg" alt="image" class="img-responsive zoom-img"></div>
								<div class="info-box">
									<div class="info-content simpleCart_shelfItem">
											<h4>50%offer</h4>	
									</div>
				...
				<div class="col-md-4 con-tp-lft animated wow fadeInRight" data-wow-delay=".5s">
					<a href="View/Customer/products.php">
						<div class="content-grid-effect slow-zoom vertical">
							<div class="img-box"><img src="View/images/14.jpg" alt="image" class="img-responsive zoom-img"></div>
								<div class="info-box">
									<div class="info-content simpleCart_shelfItem">
											<h4>35%offer</h4>	
									</div>
				...
				<div class="content-top1">
					<div class="container">
						<div class="col-md-3 col-md2 animated wow fadeInLeft" data-wow-delay=".5s">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="View/Customer/single.php">
									<img class="img-responsive" src="View/images/pi9.png" alt="" />
								</a>
								<h3><a href="View/Customer/single.php">Trousers</a></h3>
								<div class="price">
										<h5 class="item_price">$300</h5>
					...
					<div class="col-md-3 col-md2 animated wow fadeInLeft" data-wow-delay=".5s">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="View/Customer/single.php">
									<img class="img-responsive" src="View/images/pi10.png" alt="" />
								</a>
								<h3><a href="View/Customer/single.php">Formal</a></h3>
								<div class="price">
										<h5 class="item_price">$450</h5>
					...
					<div class="col-md-3 col-md2 animated wow fadeInRight" data-wow-delay=".5s">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="View/Customer/single.php">
									<img class="img-responsive" src="View/images/pi11.png" alt="" />
								</a>
								<h3><a href="View/Customer/single.php">Trousers</a></h3>
								<div class="price">
										<h5 class="item_price">$350</h5>
					...
					<div class="col-md-3 col-md2 animated wow fadeInRight" data-wow-delay=".5s">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="View/Customer/single.php">
									<img class="img-responsive" src="View/images/pi12.png" alt="" />
								</a>
								<h3><a href="View/Customer/single.php">Formal</a></h3>
								<div class="price">
										<h5 class="item_price">$400</h5>
				...
				<div class="container">
						...
						<div class="col-md-3 footer-bottom-cate animated wow fadeInRight" data-wow-delay=".5s">
							...
							<ul>
								...
								<li><a href="View/Customer/single.php">Curabitur sapien</a></li>
								<li><a href="View/Customer/men.php">Dignissim purus</a></li>
								<li><a href="View/Customer/single.php">Dignissim neque</a></li>
								<li><a href="View/Customer/men.php">Ornared id aliquet</a></li>
