...
<html>
	<head>
		<title>Elegante Fashion House - Men Shirts</title>
		...
		<meta name="keywords" content="Elegante FashioN House, Youth Fashion, Ghana Fashion House, Contemporary Designs, men Shirts" />
				...
				<div class="col-md-9">
					<div class="content-top1">
						<div class="col-md-4 col-md4">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="single.html">
									<img class="img-responsive" src="../images/longsleeves.png" alt="" />
								</a>
								<h3><a href="single.php">Shirt - Long Sleeves</a></h3>
								<div class="price">
					...
					<div class="col-md-4 col-md4">
							<div class="col-md1 simpleCart_shelfItem">
								...
								<h3><a href="single.php">Casual Shirt</a></h3>
								<div class="price">
										<h5 class="item_price">$30</h5>
										<a href="#" class="item_add">Add To Cart</a>
										<div class="clearfix"> </div>
								</div>
					...
					<div class="col-md-4 col-md4">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="single.html">
									<img class="img-responsive" src="../images/shirt1.png" alt="" />

								</a>
								<h3><a href="single.php">Casual</a></h3>
								<div class="price">
					...
					<div class="content-top1">
						<div class="col-md-4 col-md4">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="single.html">
									<img class="img-responsive" src="../images/fromal.png" alt="" />
					...
					<div class="col-md-4 col-md4">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="single.html">
									<img class="img-responsive" src="../images/designed.png" alt="" />

								</a>
								<h3><a href="single.php">Designer Wear</a></h3>
								<div class="price">
										<h5 class="item_price">$50</h5>
										<a href="#" class="item_add">Add To Cart</a>
										<div class="clearfix"> </div>
					...
					<div class="col-md-4 col-md4">
							<div class="col-md1 simpleCart_shelfItem">
								...
								<a href="single.php">
									<img class="img-responsive" src="../images/fommal2.jpg" alt="" />
								</a>
								<h3><a href="single.php">Formal</a></h3>
								<div class="price">
										<h5 class="item_price">$30</h5>
					...
					<div class="content-top1">
						<div class="col-md-4 col-md4">
							<div class="col-md1 simpleCart_shelfItem">
								<a href="single.php">
									<img class="img-responsive" src="../images/shirt4.png" alt="" />
								</a>
								<h3><a href="single.php">Shirt and Tie</a></h3>
								<div class="price">
										<h5 class="item_price">$70</h5>
										<a href="#" class="item_add">Add To Cart</a>
										<div class="clearfix"> </div>
